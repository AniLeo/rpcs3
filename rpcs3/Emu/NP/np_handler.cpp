...
np_handler::np_handler(cereal_load& ar)
	: np_handler()
{
	ar(is_netctl_init, is_NP_init, is_NP_Lookup_init, is_NP_Score_init, is_NP2_init, is_NP2_Match2_init, is_NP_Auth_init
...
void np_handler::save(cereal_save& ar)
{
	// TODO: See ctor
	ar(is_netctl_init, is_NP_init, is_NP_Lookup_init, is_NP_Score_init, is_NP2_init, is_NP2_Match2_init, is_NP_Auth_init
		, manager_cb, manager_cb_arg, basic_handler, basic_handler_arg, is_connected, is_psn_active
